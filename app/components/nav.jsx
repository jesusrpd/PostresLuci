...
export default function Nav(){
    ...
    return(
        ...
        <nav className="sticky top-0 flex justify-around items-center w-full bg-black-elote py-5 z-50 md:hidden">
            ...
            <Image src="/img/logo.png" width={70} height={70} className="mx-3 md:mx-2 rounded-full lg:mx-3" alt="logo The Elote Co"/>
            <ul className="flex">
                ...
                <li className="mx-1 lg:mx-5 font-bold bg-red-elote p-1 rounded-2xl px-4 text-white"><a href="https://wa.me/5544923181/?text=¡Hola!%20Me%20gustaría%20un%20pedido" target="_blank">Cotizar</a></li>
            </ul>
            </nav>
        </>
    )
